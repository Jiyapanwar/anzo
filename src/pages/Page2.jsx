...
const Page2 = () => {
  ...
  return (
    <div id="section2" className="bg-white text-black text-center p-12">
      <h3 className="text-gray-400 text-xl font-[anzo1]">
        anzo.studio 2024 | designed and developed
      </h3>
      <div id="rotateText" className="mt-20">
        <h1 className="text-[42vw] text-black font-[anzo2] leading-[35vw]">
          IMPACTFUL
        </h1>
      </div>
      <div id="rotateText">
